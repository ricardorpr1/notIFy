...
<head>
  ...
  <style>
    ...
    #meusEventosBtn { position:fixed; top:20px; left:20px; background:#007bff; color:#fff; border:none; padding:10px 16px; border-radius:6px; cursor:pointer; z-index:1100; display:inline-block; }
    #addEventBtn, #permissionsBtn { position:fixed; top:20px; left:160px; background:#228b22; color:#fff; border:none; padding:10px 16px; border-radius:6px; cursor:pointer; z-index:1100; display:none; }
    #permissionsBtn { left:310px; background:#6f42c1; } 
    #gerenciarCursosBtn { position:fixed; top:20px; left:450px; background:#007bff; color:#fff; border:none; padding:10px 16px; border-radius:6px; cursor:pointer; z-index:1100; display:none; }
    ...
    .modal-image-full { width: 100%; max-width: 100%; height: auto; border-radius: 6px; margin-top: 15px; border: 1px solid #eee; }
  ...
  <div id="overlay" aria-modal="true" role="dialog">
    <div id="viewModal" class="modal" role="document">
      ...
      <div class="modal-footer">
        <button id="btnVerAvaliacoes" class="btn btn-ver-avaliacoes" style="display:none; margin-right: auto;">Ver Avaliações</button>
